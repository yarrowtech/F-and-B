...
const paymentHistory = [
  { month: "Jan", year: 2025, basic: 30000, allowances: 5000, deductions: 2000 },
  { month: "Feb", year: 2025, basic: 30000, allowances: 5000, deductions: 2000 },
  { month: "Mar", year: 2025, basic: 30000, allowances: 6000, deductions: 2000 },
];

const attendanceData = [
  { month: "Jan", year: 2025, present: 20, absent: 5, leaves: 2 },
  { month: "Feb", year: 2025, present: 22, absent: 3, leaves: 2 },
  { month: "Mar", year: 2025, present: 25, absent: 2, leaves: 1 },
];
    ...
    <div className="min-h-screen bg-gray-50 p-4 dark:bg-gray-900 sm:p-6 print:bg-white">
      <header className="sticky top-0 z-10 mb-4 border-b bg-gray-50/80 backdrop-blur dark:border-neutral-800 dark:bg-gray-900/80 print:static print:border-none print:bg-white">
        <div className="mx-auto flex max-w-5xl items-center justify-between py-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Cleaner Profile</h1>
        ...
        <nav
          role="tablist"
          aria-label="Cleaner profile sections"
