...
const CleanerSidebar = ({ activeSection, setActiveSection }) => {
  ...
  const [CleanerLoginId, setCleanerLoginId] = useState(
    localStorage.getItem("CleanerLoginId") || "Cleaner789"
  );
  const [CleanerName, setCleanerName] = useState(
    generateName(localStorage.getItem("CleanerLoginId") || "Cleaner789")
  );
  ...
  useEffect(() => {
    const handleStorageChange = () => {
      const loginId = localStorage.getItem("CleanerLoginId") || "Cleaner789";
      setCleanerLoginId(loginId);
    };
  ...
  useEffect(() => {
    setCleanerName(generateName(CleanerLoginId));
  }, [CleanerLoginId]);
