  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="rounded-[28px] bg-gradient-to-r from-slate-900 via-slate-800 to-emerald-900 p-6 text-white shadow-xl">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-3 text-3xl font-bold">Waiter Dashboard</h1>
        ...
        <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
          <div className="flex flex-wrap items-center gap-3">
            <div className="min-w-[140px]">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Filter Orders</p>
          ...
          <div className="border-b border-slate-200 bg-slate-50/80 px-6 py-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Orders placed by you in the selected range.</p>
              </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredOrders.map((order) => (
                  <tr key={order._id}>
                    ...
                    <td className="px-4 py-3 text-slate-600">{order.status || "PENDING"}</td>
                    <td className="px-4 py-3 text-slate-600">{formatDate(order.createdAt)}</td>
                  </tr>
                ))}
              </tbody>
