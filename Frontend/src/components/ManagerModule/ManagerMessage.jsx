...
const ManagerMessages = () => {
  ...
  return (
    <div className="flex h-[100dvh] flex-col md:flex-row bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-all duration-300 overflow-hidden">
      {/* Sidebar */}
      <aside className="w-full md:w-72 h-56 md:h-auto shrink-0 bg-white dark:bg-gray-800 border-b md:border-b-0 md:border-r dark:border-gray-700 flex flex-col">
        <div className="p-4 border-b dark:border-gray-700">
          <h2 className="text-xl font-bold">Manager Chat</h2>
        </div>

        {/* Tabs */}
        <div className="flex flex-wrap justify-around gap-2 mt-2 mb-4 px-2">
