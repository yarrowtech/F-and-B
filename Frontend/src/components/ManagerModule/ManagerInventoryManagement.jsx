...
const ManagerInventory = () => {
  /* get manager's restaurant from localStorage */
    ...
    <div className="p-6 min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {restaurantName && (
        <p className="text-lg text-gray-500 dark:text-gray-400 mb-5">
          Inventory for{" "}
          <span className="font-semibold text-gray-700 dark:text-gray-200">{restaurantName}</span>
        </p>
      )}
