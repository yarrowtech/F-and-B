...
//         value: 128,
//         icon: <FaEnvelopeOpenText className="text-indigo-500 text-3xl" />,
//       },
//       { title: "Total Branches", value: 12, icon: <FaBuilding className="text-green-500 text-3xl" /> },
//       { title: "Total Employees", value: 85, icon: <FaUserFriends className="text-blue-500 text-3xl" /> },
//       { title: "Orders Today", value: 245, icon: <FaShoppingBasket className="text-orange-500 text-3xl" /> },
//       { title: "Reservations Today", value: 78, icon: <FaCalendarAlt className="text-pink-500 text-3xl" /> },
//       { title: "Monthly Revenue", value: 2033500, icon: <FaRupeeSign className="text-teal-500 text-3xl" /> },
//       { title: "Daily Revenue", value: 103750, icon: <FaRupeeSign className="text-emerald-500 text-3xl" /> },
//       { title: "Inventory Alerts", value: 6, icon: <FaBell className="text-red-500 text-3xl" /> },
//     ],
//     []
//   );
...
//     { id: 3, message: "cheif Ramesh marked an order as delayed.", time: "11:00 AM" },
...
//   return (
//     <div className="p-6 bg-gradient-to-br from-gray-100/60 to-white/30 dark:from-gray-900/60 dark:to-gray-800/30 text-gray-800 dark:text-gray-200 min-h-screen space-y-8 overflow-y-auto">
//       <div className="flex justify-between items-center">
//         <h1 className="text-3xl font-bold mb-6 text-black-700 dark:text-green-400">Dashboard</h1>
//       </div>
...
//           <div
//             key={index}
//             className="bg-white/20 dark:bg-white/10 backdrop-blur-md border border-white/30 dark:border-white/10 rounded-2xl shadow-lg p-5 flex items-center gap-4 hover:shadow-xl transition"
//           >
//             {kpi.icon}
//             <div>
//               <p className="text-sm text-gray-500 dark:text-gray-400">{kpi.title}</p>
//               <h2 className="text-xl font-semibold">
//                 {typeof kpi.value === "number" && kpi.title.includes("Revenue")
...
//             <li
//               key={note.id}
//               className="bg-white/40 dark:bg-black/20 rounded-lg p-3 text-sm shadow hover:shadow-md transition flex justify-between items-center"
//             >
//               <span className="text-gray-800 dark:text-gray-100">{note.message}</span>
...
//       {/* Charts */}
//       <GraphBlock title="Overall Performance">
...
//           <Line type="monotone" dataKey="reservations" stroke="#F59E0B" />
//         </LineChart>
//       </GraphBlock>

//       {/* (other GraphBlock sections remain the same) */}
//     </div>
//   );
// };
