        ...
        <form onSubmit={onSubmit} className="flex min-h-0 flex-1 flex-col">
          ...
          <div className="rounded-3xl border border-gray-200 bg-gray-50/80 p-4 dark:border-neutral-700 dark:bg-neutral-900/40">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Choose whether this local vendor will log in or be managed only by admin.
            </p>
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              <label
                className={`cursor-pointer rounded-2xl border px-4 py-3 transition ${
                  form.loginAccess === "required"
              ...
              >
                <input
                  ...
                  name="loginAccess"
                  value="required"
                  checked={form.loginAccess === "required"}
                  onChange={(e) => onChange("loginAccess", e.target.value)}
                  className="sr-only"
                />
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                  Local Vendor With Login
                </p>
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Vendor gets invitation link and can log in to their account.
                </p>
              </label>
              <label
                className={`cursor-pointer rounded-2xl border px-4 py-3 transition ${
                  form.loginAccess === "not_required"
                    ? "border-green-400 bg-green-50 dark:border-green-500 dark:bg-green-950/30"
                    : "border-gray-200 bg-white dark:border-neutral-700 dark:bg-neutral-800"
                }`}
              >
                <input
                  ...
                  name="loginAccess"
                  value="not_required"
                  checked={form.loginAccess === "not_required"}
                  onChange={(e) => onChange("loginAccess", e.target.value)}
                  className="sr-only"
                />
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                  Local Vendor Without Login
                </p>
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Admin manages vendor profile, orders, and communication.
                </p>
              </label>
            </div>
          </div>
          ...
          {form.loginAccess === "required" ? (
            ...
            <div className="mt-4 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800 dark:border-blue-900/50 dark:bg-blue-950/20 dark:text-blue-200">
              This vendor will not log in. Admin will manage the vendor profile, orders, and communication through WhatsApp, email, or phone.
            </div>
          )}
          ...
          <div className="flex flex-col gap-3 border-t border-gray-100 bg-white px-5 py-4 dark:border-neutral-700 dark:bg-neutral-800">
            ...
            >
              ...
              {saving
                ? "Creating Vendor..."
                : form.loginAccess === "required"
                  ? "Create Local Vendor With Login"
                  : "Create Local Vendor Without Login"}
            </button>
            </div>
          </div>
        </form>
          ...
          {mode === "view" ? (
            <div className="space-y-6">
              ...
              <DetailSection title="Identification">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <span className="rounded-full bg-blue-100 px-3 py-1 text-xs font-semibold text-blue-700 dark:bg-blue-900/40 dark:text-blue-300">
                    {vendor.loginAccess === "not_required" ? "No Login" : "Login Required"}
                  </span>
                  {vendor.category && (
              ...
              {vendor.loginAccess === "not_required" && (
                <div className="rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm font-medium text-blue-700 dark:border-blue-800 dark:bg-blue-950/30 dark:text-blue-300">
                  This local vendor is admin-managed and does not use vendor login.
                </div>
              )}
              ...
              <div className="grid grid-cols-1 gap-2 border-t border-gray-100 pt-5 dark:border-neutral-700 sm:grid-cols-3">
                ...
                <button
                  ...
                  disabled={isUpgradeLocked || vendor.loginAccess === "not_required"}
                ...
                >
                  <KeyRound size={15} /> {vendor.loginAccess === "not_required" ? "No Login Access" : "Reset Password"}
                </button>
                <button
                  type="button"
...
export default function AdminVendorManagement() {
  ...
  const validate = () => {
    ...
    if (form.loginAccess === "required" && !form.email.trim()) {
      nextErrors.email = "Email is required for invitation";
    }
  ...
  const handleCreateVendor = async (event) => {
    ...
    try {
      ...
      if (form.loginAccess === "required" && invitationLink) {
        setInvitationData({
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
        ...
        <div className="mb-5 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800 dark:border-blue-900/50 dark:bg-blue-950/20 dark:text-blue-200">
          Your current vendor workflow stays unchanged. This section also supports an admin-managed vendor flow where the vendor does not need to log in, and the admin can maintain the vendor profile and coordinate through WhatsApp, email, or phone.
        </div>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span className="rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-700 dark:bg-blue-900/40 dark:text-blue-300">
                          {vendor.loginAccess === "not_required" ? "No Login" : "Login"}
                        </span>
                      </div>
                    </td>
                    <td className="px-4 py-3">
