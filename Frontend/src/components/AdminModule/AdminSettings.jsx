    ...
    <div className="p-4 md:p-6 bg-gray-50 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-200">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <section className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow">
          ...
          {/* Two-Factor Authentication */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between py-3 border-b border-gray-200 dark:border-gray-700">
          ...
          {/* Change Password */}
          <button className="flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:underline py-3 border-b border-gray-200 dark:border-gray-700 w-full text-left text-sm md:text-base">
            <LockKeyhole size={16} /> Change Password
          </button>
