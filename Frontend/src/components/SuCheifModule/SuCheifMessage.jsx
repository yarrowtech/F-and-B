...
const SuCheifMessages = () => {
    ...
    () => [
      {
        ...
        name: "Manager",
        messages: [
          { from: "sucheif", content: "Prep list for dinner shared.", time: "08:45 AM" },
  ...
  const handleSend = () => {
    ...
    const newMsg = { from: "sucheif", content: messageInput.trim(), time };
...
export default SuCheifMessages;
