      ...
      <div className="relative mx-auto max-w-7xl px-6 py-6 md:px-10">
        {homeOnly ? (
          ...
          >
            <Link
              to="/"
              className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-green-900 text-white shadow-lg transition hover:scale-105 hover:bg-green-800 dark:bg-[#6fbd58] dark:text-[#061006]"
