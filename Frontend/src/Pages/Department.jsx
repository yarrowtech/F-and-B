...
const Department = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-gray-800 p-4 sm:p-8">
      ...
      <h1 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-10 text-gray-800 dark:text-white">
        Departments
      </h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-5 sm:gap-8 max-w-6xl mx-auto">
        {departments.map((dept) => (
          <div
            ...
            className={`group relative border-2 ${dept.color} rounded-xl shadow-lg p-5 sm:p-8 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer overflow-hidden`}
          >
