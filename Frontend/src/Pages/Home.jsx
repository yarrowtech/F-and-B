...
const Home = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-[#120c09] text-white">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(132,204,22,0.1),_transparent_18%),radial-gradient(circle_at_bottom_left,_rgba(74,222,128,0.12),_transparent_25%)]" />
      ...
      <main className="relative overflow-hidden px-4 pb-16 md:px-8">
        <section id="services" className="scroll-mt-28 py-20">
          <div className="mx-auto max-w-7xl rounded-[2.4rem] border border-white/8 bg-[#17100d]/90 p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_28px_80px_-35px_rgba(0,0,0,0.9)] backdrop-blur md:p-12">
            <div className="mx-auto mb-14 max-w-3xl text-center">
              <span className="inline-flex rounded-full border border-lime-300/20 bg-lime-400/10 px-4 py-1 text-sm font-semibold uppercase tracking-[0.2em] text-lime-300">
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-5">
              {serviceCards.map(({ title, description, icon }, index) => (
                <motion.article
                  ...
                  whileHover={{ y: -10 }}
                  className="rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,_rgba(255,255,255,0.06)_0%,_rgba(255,255,255,0.02)_100%)] p-6 shadow-[0_18px_40px_-28px_rgba(132,204,22,0.24)]"
                >
                  <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-lime-300 to-green-500 text-[#140d09] shadow-[0_14px_30px_-18px_rgba(132,204,22,0.9)]">
                    {icon}
                  </div>
        ...
        <section id="about" className="scroll-mt-28 py-8">
          <div className="mx-auto grid max-w-7xl items-center gap-10 rounded-[2.4rem] border border-white/8 bg-[#18110d]/92 p-8 shadow-[0_28px_80px_-35px_rgba(0,0,0,0.9)] md:grid-cols-[0.95fr_1.05fr] md:p-12">
            <div className="relative overflow-hidden rounded-[2rem] border border-lime-300/10 bg-black/30 p-4">
              <img
                src={aboutImage}
              ...
              <div className="absolute inset-x-8 bottom-8 rounded-[1.4rem] border border-white/10 bg-black/35 p-6 backdrop-blur-md">
                <p className="text-xs uppercase tracking-[0.3em] text-lime-300">About The Platform</p>
        ...
        <section id="contact" className="scroll-mt-28 py-20">
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-8 lg:grid-cols-[1fr_0.95fr]">
              <div className="rounded-[2.4rem] border border-lime-300/14 bg-[linear-gradient(140deg,_rgba(132,204,22,0.18)_0%,_rgba(34,197,94,0.12)_100%)] p-8 shadow-[0_18px_70px_-35px_rgba(132,204,22,0.42)] backdrop-blur md:p-10">
                <span className="inline-flex rounded-full border border-white/10 bg-black/20 px-4 py-1 text-sm font-semibold uppercase tracking-[0.2em] text-lime-200">
                  Final Section
                </span>
                <h2 className="mt-6 text-4xl font-black text-white md:text-5xl">
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-2">
                  {contactCards.map(({ label, value, icon }) => (
                    <div key={label} className="rounded-[1.7rem] border border-white/10 bg-black/20 p-5 backdrop-blur-sm">
                      <div className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-white/12 text-lime-300">
                        {icon}
                      </div>
              ...
              <form className="rounded-[2.4rem] border border-white/8 bg-[#17100d]/92 p-8 shadow-[0_28px_80px_-35px_rgba(0,0,0,0.9)] backdrop-blur md:p-10">
                ...
                <div className="mt-8 grid gap-4">
                  <input
                    ...
                    className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white outline-none transition placeholder:text-white/35 focus:border-lime-300/50"
                  />
                  <input
                    type="email"
                  ...
                  <button
                    type="button"
                    className="rounded-full bg-gradient-to-r from-lime-300 to-green-500 px-6 py-3 font-bold text-[#140d09] transition hover:-translate-y-1"
                  >
                    Send Message
                  </button>
                </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <div className="mt-6 flex flex-col gap-2 text-sm text-white/55">
              <a href="#hero" className="transition hover:text-lime-300">
                Back to top
              </a>
          ...
          <div className="overflow-hidden rounded-[1.8rem] border border-white/10 bg-white/5 p-3 shadow-[0_18px_50px_-28px_rgba(0,0,0,0.8)]">
            <div className="mb-3 px-2">
              <p className="text-xs uppercase tracking-[0.28em] text-lime-300">Address</p>
