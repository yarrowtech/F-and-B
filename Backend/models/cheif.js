...
//     cheifId: { type: String, unique: true, required: true }, // system ID (unique)
...
// cheifSchema.pre("save", async function (next) {
...
// // Match password
// cheifSchema.methods.matchPassword = async function (enteredPassword) {
//   return await bcrypt.compare(enteredPassword, this.password);
// };

// module.exports = mongoose.model("Cheif", cheifSchema);
