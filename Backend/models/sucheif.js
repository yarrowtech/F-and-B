...
// const sucheifSchema = new mongoose.Schema(
//   {
...
//     sucheifId: { type: String, unique: true, required: true }, // system ID (unique)
...
// sucheifSchema.pre("save", async function (next) {
...
// // Match password
// sucheifSchema.methods.matchPassword = async function (enteredPassword) {
//   return await bcrypt.compare(enteredPassword, this.password);
// };

// module.exports = mongoose.model("Sucheif", sucheifSchema);
